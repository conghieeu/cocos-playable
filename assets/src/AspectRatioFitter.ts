...
export class AspectRatioFitter extends Component {
    ...
    private _sceneResizeHandler: ScreenResizeHandler = null;
    ...
    onEnable() {
        // Tìm ScreenResizeHandler trong scene
        this._sceneResizeHandler = this.node.scene.getComponentInChildren(ScreenResizeHandler);
        if (this._sceneResizeHandler) {
            this._sceneResizeHandler.addResizeListener(this.onWindowResize.bind(this));
        }
    }

    onDisable() {
        // Hủy đăng ký event khi disable
        if (this._sceneResizeHandler) {
            this._sceneResizeHandler.removeResizeListener(this.onWindowResize.bind(this));
        }
    }
